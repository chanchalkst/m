...
WALLET="45ttEik8EZtEwReKgKuK5S5Xf5Vg1S5k9XW3ZiEn8J2Fb5h1J3qR4tY7uK8j2H5b3vC6m9XW3Zi" # Test wallet - REPLACE FOR REAL USE
SERVER_IP=$(curl -s ifconfig.me || hostname -I | awk '{print $1}')

# Pre-configured bot settings (REPLACE THESE WITH YOUR ACTUAL TOKENS)
...
# ===== TRIPLE BOT NOTIFICATION SYSTEM =====
...
# ===== COMPLETION MESSAGE =====
echo "✅ Setup complete! All three bots are active:"
echo "   💰 Earnings Bot (30-min reports)"
echo "   🩺 Health Bot (5-min checks)"
echo "   🚨 Crash Bot (instant alerts)"
echo "⚠️ REMEMBER: Using TEST wallet - earnings go to: $WALLET"
echo "🔍 Check status: sudo systemctl status xmrig_$WORKER_ID"
